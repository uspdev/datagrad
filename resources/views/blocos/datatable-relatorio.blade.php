{{--
Datatables, botoes excel e csv, sem paginação, fixed header, topo em 1 linha, alinhado esquerda
...
@once
  ...
  @section('javascripts_bottom')
    ...
    <script>
      jQuery(function() {
        var datatableRelatorio = $('.datatable-relatorio').DataTable({
          ...
          fixedHeader: {{ $dtFixedHeader ?? true }},
          buttons: {
            buttons: [{
                extend: 'excelHtml5',
