...
<div class="card" id="card-basico">
  ...
  <div class="card-body">
    ...
    <hr />
    <x-disciplina-textarea-show name='pgmrsudis' :dr="$dr"></x-disciplina-textarea-show>
    <x-disciplina-textarea-show class="mt-3" name='objdis' :dr="$dr"></x-disciplina-textarea-show>
    <x-disciplina-textarea-show class="mt-3" name='pgmdis' :dr="$dr"></x-disciplina-textarea-show>
    <x-disciplina-textarea-show class="mt-3" name='mtdens' :dr="$dr"></x-disciplina-textarea-show>
